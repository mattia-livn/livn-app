# IMU 2025 - TORBOLE-CASAGLIA

## Informazioni Generali

- **Comune**: TORBOLE CASAGLIA
- **Anno**: 2025
- **Delibera**: n. 19 del 28/12/2024
...
|-----------|-------------|----------|
| Comune oggetto di fusione/incorporazione che applica aliquot... | Comune oggetto di fusione/incorporazione che applica aliquote differenziate nei ... | 0,55% |
...
| Fabbricati appartenenti al gruppo catastale D (esclusa la ca... | Fabbricati appartenenti al gruppo catastale D (esclusa la categoria catastale D/... | 0,96% |
| Terreni agricoli | Terreni agricoli | 0,76% |
| Aree fabbricabili | Aree fabbricabili | 0,96% |
| Altri fabbricati (fabbricati diversi dall'abitazione princip... | Altri fabbricati (fabbricati diversi dall'abitazione principale e dai fabbricati... | 0,96% |

### Dettaglio Completo Aliquote

#### 1. 0,55% - Comune oggetto di fusione/incorporazione che applica aliquote differenziate nei preesistenti comuni: NO
...
#### 3. 0,96% - Fabbricati appartenenti al gruppo catastale D (esclusa la categoria catastale D/10)
...
#### 6. 0,96% - Altri fabbricati (fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo
catastale D)
...
immobili di proprietà di ONLUS o enti del terzo settore con eventuali condizioni dell'esenzione presenti nel regolamento: Articolo 19
...
Esenzione dal pagamento IMU(quota comune) per gli immobili concessi in comodato gratuito, con contratto registrato, al comune o ad altro ente territoriale, destinati esclusivamente all’esercizio dei rispettivi compiti istituzionali previa dichiarazione entro il 30.06 dell'anno successivo a quello in cui si verificano i presupposti..
...
---
*Documento generato automaticamente da: torbole-casaglia.pdf*  
*Elaborato il: 10/06/2025, 16:45:32*  
*Estratto testo completo di 3338 caratteri*
