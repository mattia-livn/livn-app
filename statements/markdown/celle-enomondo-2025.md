# IMU 2025 - CELLE-ENOMONDO

## Informazioni Generali

- **Comune**: CELLE ENOMONDO
- **Anno**: 2025
- **Delibera**: n. 44 del 23/12/2024
...
|-----------|-------------|----------|
| Comune oggetto di fusione/incorporazione che applica aliquot... | Comune oggetto di fusione/incorporazione che applica aliquote differenziate nei ... | 0,54% |
...
| Fabbricati appartenenti al gruppo catastale D (esclusa la ca... | Fabbricati appartenenti al gruppo catastale D (esclusa la categoria catastale D/... | 0,94% |
| Terreni agricoli | Terreni agricoli | 0,84% |
| Aree fabbricabili | Aree fabbricabili | 0,94% |
| Altri fabbricati (fabbricati diversi dall'abitazione princip... | Altri fabbricati (fabbricati diversi dall'abitazione principale e dai fabbricati... | 0,94% |

### Dettaglio Completo Aliquote

#### 1. 0,54% - Comune oggetto di fusione/incorporazione che applica aliquote differenziate nei preesistenti comuni: NO
...
#### 3. 0,94% - Fabbricati appartenenti al gruppo catastale D (esclusa la categoria catastale D/10)

**Descrizione completa:**
Fabbricati appartenenti al gruppo catastale D (esclusa la categoria catastale D/10)

#### 4. 0,84% - Terreni agricoli

**Descrizione completa:**
Terreni agricoli

#### 5. 0,94% - Aree fabbricabili

**Descrizione completa:**
Aree fabbricabili

#### 6. 0,94% - Altri fabbricati (fabbricati diversi dall'abitazione principale e dai fabbricati appartenenti al gruppo
catastale D)
...
---
*Documento generato automaticamente da: celle-enomondo.pdf*  
*Elaborato il: 10/06/2025, 16:45:14*  
*Estratto testo completo di 2640 caratteri*
